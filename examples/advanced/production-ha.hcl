...
#   (web-hpa.yaml maxReplicas: 1). See docs/infrastructure/storage.md §'Web Replica Constraint'.
...
# See docs/infrastructure/storage.md §'Web Replica Constraint' for details and upgrade path.
web_count = 1
